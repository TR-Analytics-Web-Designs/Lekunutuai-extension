...
# Setup logging
logging.basicConfig(filename='new_model_evaluation.log', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
ensemble_transaction_model = load_model_safely('C:/Users/Admin/Desktop/lekunutuai-extension/models/new_fastapi_ensemble_transaction_model.joblib')
ensemble_link_model = load_model_safely('C:/Users/Admin/Desktop/lekunutuai-extension/models/new_fastapi_ensemble_link_model.joblib')
